...
if st.session_state.page == 'welcome':
    ...
    with col2:
        logo_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/200px-React-icon.svg.png" 
        try:
...
# ==========================================
    ...
    if st.button("🤖 Use AI Detection (Auto)", use_container_width=True, type="secondary"):
        if st.session_state.mode == 'exam':
            ...
            st.session_state.traffic_cases = {
                "লাল বাতি অমান্য করা": "৫০০০ টাকা জরিমানা (ধারা-৮৭)",
                "অতিরিক্ত গতি": "৩০০০ টাকা জরিমানা (ধারা-৮৮)",
                "হেলমেট না থাকা": "১০০০ টাকা জরিমানা (ধারা-৯০)"
            }
    ...
    with st.form("input_form"):
        if st.session_state.mode == 'exam':
            ...
            case_details = st.text_input("শাস্তি/জরিমানা (Case):", "২০০০ টাকা জরিমানা")
...
# ==========================================
    ...
    with tab1:
        ...
        # ⚠️ তোমার ESP32-CAM এর সিরিয়াল মনিটরে পাওয়া আইপি অ্যাড্রেসটি এখানে বসাবে
        camera_ip = "http://192.168.1.100:81/stream" 
        ...
        if run_camera:
            ...
            while run_camera:
                ret, frame = cap.read()
                if not ret:
                    st.error("ক্যামেরা থেকে ভিডিও পাওয়া যাচ্ছে না! IP Address এবং ওয়াইফাই কানেকশন চেক করুন।")
                    break
    ...
    with tab4:
        ...
        if st.button("Update Rules"):
            ...
            st.success("নিয়মাবলি সফলভাবে আপডেট করা হয়েছে!")
